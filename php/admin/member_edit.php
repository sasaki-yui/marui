...
<div class="menu">
    <ul id="nav">
        ...
        <input type="hidden" name="id" value="<?=$edits['id'] ?>">
            <p>ID<?php if(!empty($edits['id'])) print $edits["id"]; ?></p>
            <p>氏名
                <label for="name_sei">姓</label>
                    <input type="text" name="name_sei" value="<?php if (!empty($edits['id'])) print $edits["name_sei"]; ?>">
                ...
                <label for="name_mei">名</label>
                    <input type="text" name="name_mei" value="<?php if (!empty($edits['id'])) print $edits["name_mei"]; ?>">
                        <?php if (isset($error["name_mei"]) && $error['name_mei'] == 'blank'): ?>
            ...
            <div class="control">
                <p>性別
                    <label for="gender">
                        <input type="radio" name="gender" value="1" <?php if (($edits['gender'])=="1") print 'checked'; ?>>男性
                        <input type="radio" name="gender" value="2" <?php if (($edits['gender'])=="2") print 'checked'; ?>>女性
                    </label>
            ...
            <div class="control">
                <label for="email">メールアドレス</label>
                    <input id="email" type="email" name="email" value="<?php if (!empty($edits['id'])) print $edits["email"]; ?>">
